...
def install():
	...
	if distro == 'debian' or distro == 'ubuntu':
		...
		print('Instalando sistema...')
		os.system('mariadb-server zabbix-proxy-mysql zabbix-get zabbix-agent -y 1>/dev/null')
		os.system('systemctl start mariadb-server')
		os.system('systemctl enable mariadb-server')
